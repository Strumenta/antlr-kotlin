...
@header {
import org.antlr.v4.kotlinruntime.benchmarks.mysql.MySQLBaseLexer
import org.antlr.v4.kotlinruntime.benchmarks.mysql.SqlMode
}
...
LOGICAL_OR_OPERATOR:
    '||' { this.type = if (this.isSqlModeActive(SqlMode.PipesAsConcat)) MySQLLexer.Tokens.CONCAT_PIPES_SYMBOL else MySQLLexer.Tokens.LOGICAL_OR_OPERATOR }
;
BITWISE_OR_OPERATOR: '|';
...
ADDDATE_SYMBOL:
    A D D D A T E                                                                       { this.type = this.determineFunction(MySQLLexer.Tokens.ADDDATE_SYMBOL) }
;                                                                                       // MYSQL-FUNC
...
BIT_AND_SYMBOL:
    B I T '_' A N D                                                                     { this.type = this.determineFunction(MySQLLexer.Tokens.BIT_AND_SYMBOL) }
;                                                                                       // MYSQL-FUNC
BIT_OR_SYMBOL:
    B I T '_' O R                                                                       { this.type = this.determineFunction(MySQLLexer.Tokens.BIT_OR_SYMBOL) }
;                                                                                       // MYSQL-FUNC
BIT_SYMBOL:                         B I T;                                              // MYSQL-FUNC
BIT_XOR_SYMBOL:
    B I T '_' X O R                                                                     { this.type = this.determineFunction(MySQLLexer.Tokens.BIT_XOR_SYMBOL) }
;                                                                                       // MYSQL-FUNC
...
CAST_SYMBOL:                        C A S T                                             { this.type = this.determineFunction(MySQLLexer.Tokens.CAST_SYMBOL) }; // SQL-2003-R
...
COUNT_SYMBOL:
    C O U N T                                                                           { this.type = this.determineFunction(MySQLLexer.Tokens.COUNT_SYMBOL) }
;                                                                                       // SQL-2003-N
CPU_SYMBOL:                         C P U;
...
CURDATE_SYMBOL:
    C U R D A T E                                                                       { this.type = this.determineFunction(MySQLLexer.Tokens.CURDATE_SYMBOL) }
;                                                                                       // MYSQL-FUNC
CURRENT_SYMBOL:                     C U R R E N T;
CURRENT_DATE_SYMBOL:
    C U R R E N T '_' D A T E                                                           { this.type = this.determineFunction(MySQLLexer.Tokens.CURDATE_SYMBOL) }
;                                                                                       // Synonym, MYSQL-FUNC
CURRENT_TIME_SYMBOL:
    C U R R E N T '_' T I M E                                                           { this.type = this.determineFunction(MySQLLexer.Tokens.CURTIME_SYMBOL) }
;                                                                                       // Synonym, MYSQL-FUNC
...
CURTIME_SYMBOL:
    C U R T I M E                                                                       { this.type = this.determineFunction(MySQLLexer.Tokens.CURTIME_SYMBOL) }
;                                                                                       // MYSQL-FUNC
...
DATE_ADD_SYMBOL:
    D A T E '_' A D D                                                                   { this.type = this.determineFunction(MySQLLexer.Tokens.DATE_ADD_SYMBOL) }
;
DATE_SUB_SYMBOL:
    D A T E '_' S U B                                                                   { this.type = this.determineFunction(MySQLLexer.Tokens.DATE_SUB_SYMBOL) }
;
...
EXTRACT_SYMBOL:
    E X T R A C T                                                                       { this.type = this.determineFunction(MySQLLexer.Tokens.EXTRACT_SYMBOL) }
;                                                                                       // SQL-2003-N
...
GROUP_CONCAT_SYMBOL:
    G R O U P '_' C O N C A T                                                           { this.type = this.determineFunction(MySQLLexer.Tokens.GROUP_CONCAT_SYMBOL) }
;
...
MAX_SYMBOL:                         M A X                                               { this.type = this.determineFunction(MySQLLexer.Tokens.MAX_SYMBOL) }; // SQL-2003-N
...
MID_SYMBOL:                         M I D                                               { this.type = this.determineFunction(MySQLLexer.Tokens.SUBSTRING_SYMBOL) }; // Synonym
...
MIN_SYMBOL:                         M I N                                               { this.type = this.determineFunction(MySQLLexer.Tokens.MIN_SYMBOL) }; // SQL-2003-N
MODE_SYMBOL:                        M O D E;
...
NOT_SYMBOL:
    N O T                                                                               { this.type = if (this.isSqlModeActive(SqlMode.HighNotPrecedence)) MySQLLexer.Tokens.NOT2_SYMBOL else MySQLLexer.Tokens.NOT_SYMBOL }
;                                                                                       // SQL-2003-R
NOW_SYMBOL:                         N O W                                               { this.type = this.determineFunction(MySQLLexer.Tokens.NOW_SYMBOL) };
...
PORT_SYMBOL:                        P O R T;
POSITION_SYMBOL:
    P O S I T I O N                                                                     { this.type = this.determineFunction(MySQLLexer.Tokens.POSITION_SYMBOL) }
;                                                                                       // SQL-2003-N
...
SESSION_USER_SYMBOL:
    S E S S I O N '_' U S E R                                                           { this.type = this.determineFunction(MySQLLexer.Tokens.USER_SYMBOL) }
;                                                                                       // Synonym
...
STDDEV_SAMP_SYMBOL:
    S T D D E V '_' S A M P                                                             { this.type = this.determineFunction(MySQLLexer.Tokens.STDDEV_SAMP_SYMBOL) }
;                                                                                       // SQL-2003-N
STDDEV_SYMBOL:
    S T D D E V                                                                         { this.type = this.determineFunction(MySQLLexer.Tokens.STD_SYMBOL) }
;                                                                                       // Synonym
STDDEV_POP_SYMBOL:
    S T D D E V '_' P O P                                                               { this.type = this.determineFunction(MySQLLexer.Tokens.STD_SYMBOL) }
;                                                                                       // Synonym
STD_SYMBOL:                         S T D                                               { this.type = this.determineFunction(MySQLLexer.Tokens.STD_SYMBOL) };
STOP_SYMBOL:                        S T O P;
...
SUBDATE_SYMBOL:                     S U B D A T E                                       { this.type = this.determineFunction(MySQLLexer.Tokens.SUBDATE_SYMBOL) };
SUBJECT_SYMBOL:                     S U B J E C T;
SUBPARTITIONS_SYMBOL:               S U B P A R T I T I O N S;
SUBPARTITION_SYMBOL:                S U B P A R T I T I O N;
SUBSTR_SYMBOL:
    S U B S T R                                                                         { this.type = this.determineFunction(MySQLLexer.Tokens.SUBSTRING_SYMBOL) }
;                                                                                       // Synonym
SUBSTRING_SYMBOL:
    S U B S T R I N G                                                                   { this.type = this.determineFunction(MySQLLexer.Tokens.SUBSTRING_SYMBOL) }
;                                                                                       // SQL-2003-N
SUM_SYMBOL:                         S U M                                               { this.type = this.determineFunction(MySQLLexer.Tokens.SUM_SYMBOL) }; // SQL-2003-N
SUPER_SYMBOL:                       S U P E R;
SUSPEND_SYMBOL:                     S U S P E N D;
SWAPS_SYMBOL:                       S W A P S;
SWITCHES_SYMBOL:                    S W I T C H E S;
SYSDATE_SYMBOL:                     S Y S D A T E                                       { this.type = this.determineFunction(MySQLLexer.Tokens.SYSDATE_SYMBOL) };
SYSTEM_USER_SYMBOL:
    S Y S T E M '_' U S E R                                                             { this.type = this.determineFunction(MySQLLexer.Tokens.USER_SYMBOL) }
;
...
TRIM_SYMBOL:                        T R I M                                             { this.type = this.determineFunction(MySQLLexer.Tokens.TRIM_SYMBOL) }; // SQL-2003-N
...
VARIANCE_SYMBOL:
    V A R I A N C E                                                                     { this.type = this.determineFunction(MySQLLexer.Tokens.VARIANCE_SYMBOL) }
;
VARYING_SYMBOL:                     V A R Y I N G;                                      // SQL-2003-R
VAR_POP_SYMBOL:
    V A R '_' P O P                                                                     { this.type = this.determineFunction(MySQLLexer.Tokens.VARIANCE_SYMBOL) }
;                                                                                       // Synonym
VAR_SAMP_SYMBOL:
    V A R '_' S A M P                                                                   { this.type = this.determineFunction(MySQLLexer.Tokens.VAR_SAMP_SYMBOL) }
;
